...
print("\nColumns used for Emotion model:")
print(
    df.columns.tolist()
)
...
# ============================================================
# 11. INITIAL EMOTION DISTRIBUTION
# ============================================================

print("\n" + "=" * 70)
print("INITIAL EMOTION DISTRIBUTION")
print("=" * 70)
...
# ============================================================
# 12. CHECK CONFLICTING EMOTION LABELS
# ============================================================
...
print(
    "Texts with conflicting emotion labels:",
...
if len(small_classes) > 0:
    ...
    print(
        "\nEach emotion class should ideally contain "
...
# ============================================================
# 20. TRAIN EMOTION MODEL
# ============================================================

print("\n" + "=" * 70)
print("TRAINING EMOTION - LINEAR SVM ONLY")
print("=" * 70)
...
print("\n" + "=" * 70)
print("EMOTION FINAL TEST RESULTS")
print("=" * 70)
...
plt.title(
    "Emotion Confusion Matrix - Linear SVM"
)
...
print(
    "\nEmotion training completed successfully."
)