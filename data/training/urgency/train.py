...
print("\nColumns used for Urgency model:")
...
# Remove rows where text or urgency is missing
...
# ============================================================
# 11. INITIAL URGENCY DISTRIBUTION
# ============================================================

print("\n" + "=" * 70)
print("INITIAL URGENCY DISTRIBUTION")
print("=" * 70)
...
# ============================================================
# 12. CHECK CONFLICTING URGENCY LABELS
# ============================================================
...
# ============================================================
# 15. FINAL URGENCY DISTRIBUTION
# ============================================================

print("\n" + "=" * 70)
print("FINAL URGENCY DISTRIBUTION")
print("=" * 70)
...
if len(small_classes) > 0:
    ...
    print(
        "\nEach urgency class should ideally contain "
...
# ============================================================
# 20. TRAIN URGENCY MODEL
# ============================================================

print("\n" + "=" * 70)
print("TRAINING URGENCY - LINEAR SVM ONLY")
print("=" * 70)
...
print("\n" + "=" * 70)
print("URGENCY FINAL TEST RESULTS")
print("=" * 70)
...
plt.title(
    "Urgency Confusion Matrix - Linear SVM"
)
...
print(
    "\nUrgency training completed successfully."
)